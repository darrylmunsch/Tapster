...
class Results extends Component {
  ...
  handleClickSearch() {
    ...
    this.setState({ emptyRes: "Loading Results" });
      ...
      <div className="center_search">
        ...
        <Modal size="lg" show={this.state.show} onHide={this.handleClose} scrollable="true">
          ...
          <Nav fill variant="tabs" activekey={this.state.key} defaultactivekey="/partialTab">
            ...
            <OverlayTrigger
              placement="top"
              overlay={(<Tooltip id="hi">At least 1 matching ingredient</Tooltip>)}>
              <Nav.Item>
            ...
            <OverlayTrigger
              placement="top"
              overlay={(<Tooltip id="hi">Exact match. No extra ingredients required.</Tooltip>)}>
              <Nav.Item>
